...
const sortNumbers = (arr) => {
  return arr.sort((a, b) => a - b); // Solution code here...
};
...
const sortBackwards = (arr) => {
  return arr.sort((num1, num2) => num2 - num1); // Solution code here...
};
...
const alphabetize = (arr) => {
  return arr.sort(); // Solution code here...
};
...
const sortByPrice = (arr) => {
  return arr.sort((obj1, obj2) => obj1.price - obj2.price); // Solution code here...
};
